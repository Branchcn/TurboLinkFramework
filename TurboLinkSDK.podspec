Pod::Spec.new do |s|
    ...
    s.swift_version = '5.0'
    s.source       = {
        http: "https://github.com/Branchcn/TurboLinkFramework/releases/download/1.1.16/TurboLinkSDK.xcframework.zip",
        sha256: "ab544542f316650b5431657e7b4e3e6a37ae238e82d7e4bd9dfda1d41056e842"
    }
