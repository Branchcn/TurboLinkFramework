Pod::Spec.new do |s|
    ...
    s.swift_version = '5.0'
    s.source       = {
        http: "https://github.com/Branchcn/TurboLinkFramework/releases/download/1.0.27/TurboLinkSDK.xcframework.zip",
        sha256: "baf72ef1502d1fc47969d8ea0ef25a1db5ac7435fbf04b4678c60d4e3a80eef5"
    }
